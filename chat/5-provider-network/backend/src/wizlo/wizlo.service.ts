 ...
 *   resulting JWT's `sub` is the resolved user's id. Provider-network
 *   endpoints (this sample) require a staff user that is a member of the
 *   provider-network tenant; the M2M client identity has no such membership.
 *
