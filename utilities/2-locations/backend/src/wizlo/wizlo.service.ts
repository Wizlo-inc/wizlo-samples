 ...
 * from `POST /oauth/token` (grant `client_credentials`). The location endpoints
 * (`GET /states`, `GET /countries`, `GET /cities/state/:stateId/search`) all use
 * this tenant-scoped admin token — they are reference data, not patient-scoped.
 */
@Injectable()
