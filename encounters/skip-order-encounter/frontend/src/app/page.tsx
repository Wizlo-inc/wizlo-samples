...
export default function SkipOrderPage() {
  ...
  return (
    <div className="container">
      <h1>Skip Order Encounter</h1>
      <p className="subtitle">
        Creates an encounter without automatically generating an order. The order is created manually at a later step via <code>POST /encounters/:id/orders</code>.
      </p>
      <div className="card">
        <span className="badge">skipOrderCreation: true · reviewType: synchronous</span>
        <div className="info-box">
          After this encounter is created, call <strong>POST /encounters/:id/orders</strong> to manually create the order when ready.
        </div>
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="btn btn-primary" disabled={loading}>
            {loading ? 'Creating...' : 'Create Encounter (No Order)'}
          </button>
        </form>
        {result !== null && (
