...
export default function StandardAsyncPage() {
  ...
  return (
    <div className="container">
      <h1>Standard Async Encounter</h1>
      <p className="subtitle">
        Patient submits information; a reviewer processes it later. No live appointment is booked.
      </p>
      <div className="card">
        <span className="badge">reviewType: asynchronous · serviceQueue: internal_staff</span>
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="btn btn-primary" disabled={loading}>
            {loading ? 'Creating...' : 'Create Async Encounter'}
          </button>
        </form>
        {result !== null && (
